...
export const HeaderUser = styled.a`
  ...
  font-size: 14px;
  line-height: 20px;
  color: ${({ theme }) => theme.headerUserClr};
  ...
  &::after {
    ...
    height: 6px;
    border-radius: 1px;
    border-left: 1.9px ${({ theme }) => theme.headerUserClrAfter};
    border-bottom: 1.9px ${({ theme }) => theme.headerUserClrAfter};
...
export const PopUserSetTheme = styled.div`
  ...
  input[type="checkbox"]::before {
    ...
    height: 11px;
    border-radius: 50%;
    background-color: ${({ theme }) => theme.checkboxBeforeBg};
    transition: 0.5s;
  }
...
export const HeaderPopUserSetButton = styled.button`
  ...
  color: #565eef;
  border-radius: 4px;
  border: 1px ${({ theme }) => theme.headerUserClrAfter};
